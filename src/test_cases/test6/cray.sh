...
#
# msread VDGDATA.cdf /JAKOB/SHALLOW/EXP/EXP.0160/REFDATA.cdf
#
# copy input parameters into TMPDIR
#
cp ${SRC_DIR}/test6/exp.${EXPERIMENT} exp.data
#
# save job script on Mass Store
#
mswrite -t 4000 ${SRC_DIR}/test6/cray.sh ${MS_DIR}/cray.sh
#
...
#
# mswrite -t 4000 REFDATA.cdf ${MS_DIR}/REFDATA.cdf
#
